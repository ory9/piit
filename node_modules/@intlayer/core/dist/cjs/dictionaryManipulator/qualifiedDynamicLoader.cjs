...
*/
const isQualifiedDynamicLoaderMap = (value) => typeof value === "object" && value !== null && _intlayer_config_defaultValues.QUALIFIER_DYNAMIC_TYPES_KEY in value;
/**
...
const collectQualifiedChunks = (loaderMap, key, locale, selector) => {
	const qualifierTypes = loaderMap[_intlayer_config_defaultValues.QUALIFIER_DYNAMIC_TYPES_KEY];
