...
const getPreloadedDictionary = (loaderMap, locale) => {
	...
	const preloaded = loaderMap[_intlayer_config_defaultValues.PRELOADED_DYNAMIC_KEY];
	if (!preloaded || preloaded.locale !== locale) return void 0;
	return preloaded.dictionary;
};

//#endregion
exports.PRELOADED_DYNAMIC_KEY = _intlayer_config_defaultValues.PRELOADED_DYNAMIC_KEY;
exports.getPreloadedDictionary = getPreloadedDictionary;
//# sourceMappingURL=preloadedDynamicLoader.cjs.map