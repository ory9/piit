...
import { getSelect } from "./interpreter/getSelect.mjs";
import { getTranslation } from "./interpreter/getTranslation.mjs";
import { getInterpolableContent, isInterpolableWrapperNode, rebuildInterpolableContent, transformInterpolableNode } from "./interpreter/interpolableNode.mjs";
import { conditionPlugin, enumerationPlugin, fallbackPlugin, filePlugin, genderPlugin, insertionPlugin, nestedPlugin, pluralPlugin, selectPlugin, translationPlugin } from "./interpreter/getContent/plugins.mjs";
...
import { getNestedDictionaryGraph, getNestedDictionaryKeys, getNestedDictionaryReferences } from "./dictionaryManipulator/getNestedDictionaryReferences.mjs";
...
import { QUALIFIER_ORDER, getDictionaryCompositeIds, getDictionaryQualifierIds, getDictionaryQualifierTypes, getVariantIds } from "./dictionaryManipulator/qualifiedDictionaryDeclaration.mjs";
...
import { LocaleStorage, LocaleStorageClient, LocaleStorageServer, getLocaleFromStorage, getLocaleFromStorageClient, getLocaleFromStorageServer, localeStorageOptions, setLocaleInStorage, setLocaleInStorageClient, setLocaleInStorageServer } from "./utils/localeStorage.mjs";
import { localeResolver } from "./localization/localeResolver.mjs";
import { localeDetector } from "./localization/localeDetector.mjs";
import { getBrowserLocale } from "./localization/getBrowserLocale.mjs";
