 ...
 */
type GetPrefixResultNarrowed<L extends LocalesValues | undefined, Mode extends string = ResolvedRoutingMode, Default extends LocalesValues = ResolvedDefaultLocale> = L extends string ? [string] extends [L] ? GetPrefixResultNarrowed<DeclaredLocales, Mode, Default> : [string] extends [Mode] ? GetPrefixResult : Mode extends 'prefix-all' ? {
  prefix: `${L}/`;
  localePrefix: L;
} : Mode extends 'prefix-no-default' ? L extends Default ? {
  prefix: '';
