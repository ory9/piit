 ...
 */
type AnalyticsEventType = 'page_view' | 'content_exposure' | 'conversion';
/**
 ...
 */
type PageViewEvent = BaseAnalyticsEvent & {
  type: 'page_view';
 ...
 */
type ContentExposureEvent = BaseAnalyticsEvent & {
 ...
 */
type ConversionEvent = BaseAnalyticsEvent & {
  type: 'conversion';
 ...
 */
type AnalyticsEvent = PageViewEvent | ContentExposureEvent | ConversionEvent;
/**
 ...
 */
type TrackableEvent<E extends AnalyticsEvent = AnalyticsEvent> = Omit<E, 't' | 'url' | 'locale'> & {
...
//#endregion
export { AnalyticsClientConfig, AnalyticsEvent, AnalyticsEventType, AnalyticsIngestBody, BaseAnalyticsEvent, ContentExposureEvent, ConversionEvent, PageViewEvent, TrackableEvent };
