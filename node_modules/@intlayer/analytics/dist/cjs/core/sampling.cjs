...
*/
const isSampledIn = (sessionId, sampleRate) => {
	if (sampleRate >= 1) return true;
	if (sampleRate <= 0) return false;
	return require_utils_hash.hashString(sessionId) / 4294967295 < sampleRate;
};

//#endregion
exports.isSampledIn = isSampledIn;
