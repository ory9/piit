...
*/
const getGlobalAnalyticsClient = () => {
...
*/
const setGlobalAnalyticsClient = (client) => {
...
*/
const incrementAnalyticsClientRefCount = () => {
...
*/
const decrementAnalyticsClientRefCount = () => {
	if (typeof window === "undefined") return 0;
	const globals = window;
...
//#endregion
exports.decrementAnalyticsClientRefCount = decrementAnalyticsClientRefCount;
exports.getGlobalAnalyticsClient = getGlobalAnalyticsClient;
exports.incrementAnalyticsClientRefCount = incrementAnalyticsClientRefCount;
exports.setGlobalAnalyticsClient = setGlobalAnalyticsClient;
