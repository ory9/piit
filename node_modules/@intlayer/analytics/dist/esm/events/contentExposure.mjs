//#region src/events/contentExposure.ts
/**
...
* // "faq.2"
*/
const serializeKeyPath = (keyPath) => keyPath.map((segment) => segment.key === void 0 ? "*" : String(segment.key)).join(".");
/**
...
*/
const buildContentExposure = (params) => ({
...
//#endregion
export { buildContentExposure, serializeKeyPath };
//# sourceMappingURL=contentExposure.mjs.map