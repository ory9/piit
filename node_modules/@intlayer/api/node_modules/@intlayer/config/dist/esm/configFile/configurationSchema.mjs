...
const cookieExpiresSchema = z.union([
	z.custom(isDateLike, { message: "Expected a Date" }),
	z.number(),
	z.string().refine((value) => !Number.isNaN(Date.parse(value)), { message: "Expected a valid date string" })
]);
