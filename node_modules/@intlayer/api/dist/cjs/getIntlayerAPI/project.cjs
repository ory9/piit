...
const getProjectAPI = (authAPIOptions = {}, intlayerConfig) => {
	...
	*/
	const getProjectInsights = async (otherOptions = {}) => await require_fetcher.fetcher(`${PROJECT_API_ROUTE}/insights`, authAPIOptions, otherOptions, {
		cache: "no-store",
		method: "GET"
	});
	/**
	...
	*/
	const deleteProjectByIdAdmin = async (projectId, otherOptions = {}) => require_fetcher.fetcher(`${PROJECT_API_ROUTE}/${projectId}/admin`, authAPIOptions, otherOptions, { method: "DELETE" });
	/**
