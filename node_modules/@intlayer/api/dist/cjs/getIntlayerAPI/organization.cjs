...
const getOrganizationAPI = (authAPIOptions = {}, intlayerConfig) => {
	const ORGANIZATION_API_ROUTE = `${intlayerConfig?.editor?.backendURL ?? _intlayer_config_built.editor.backendURL}/api/organization`;
	/**
	...
	* @param organizationId - Organization ID.
	*/
	const deleteOrganizationByIdAdmin = async (organizationId, otherOptions = {}) => require_fetcher.fetcher(`${ORGANIZATION_API_ROUTE}/${organizationId}/admin`, authAPIOptions, otherOptions, { method: "DELETE" });
	/**
