...
const getAnalyticsAPI = (authAPIOptions = {}, intlayerConfig) => {
	const ANALYTICS_API_ROUTE = `${intlayerConfig?.editor?.backendURL ?? editor.backendURL}/api/analytics`;
	/**
	...
	*/
	const sendEvents = async (body, otherOptions = {}) => await fetcher(`${ANALYTICS_API_ROUTE}/events`, authAPIOptions, otherOptions, {
		method: "POST",
		body
	});
	/**
	...
	*/
	const getOverview = async (otherOptions = {}) => await fetcher(`${ANALYTICS_API_ROUTE}/overview`, authAPIOptions, otherOptions, { method: "GET" });
	/**
	...
	*/
	const getAudience = async (days = 30, otherOptions = {}) => await fetcher(`${ANALYTICS_API_ROUTE}/audience`, authAPIOptions, otherOptions, {
		method: "GET",
	...
	*/
	const getContentStats = async (otherOptions = {}) => await fetcher(`${ANALYTICS_API_ROUTE}/content-stats`, authAPIOptions, otherOptions, { method: "GET" });
	/**
	...
	*/
	const getExperimentResults = async (experimentKey, otherOptions = {}) => await fetcher(`${ANALYTICS_API_ROUTE}/experiments/${experimentKey}`, authAPIOptions, otherOptions, { method: "GET" });
	return {
		sendEvents,
		getOverview,
		getAudience,
...
*/
const analyticsEndpoint = createEndpoint(getAnalyticsAPI);

//#endregion
export { analyticsEndpoint, getAnalyticsAPI };
