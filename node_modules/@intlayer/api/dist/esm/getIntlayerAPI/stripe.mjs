...
const getStripeAPI = (authAPIOptions = {}, intlayerConfig) => {
	...
	*/
	const getAffiliateInvitations = async (params = {}, otherOptions = {}) => {
		...
		return await fetcher(`${STRIPE_API_ROUTE}/affiliate/invitations${query}`, authAPIOptions, otherOptions, { method: "GET" });
	};
	/**
	...
	*/
	...
	const getPromoCodes = async (params = {}, otherOptions = {}) => {
		const qs = params.affiliateId ? `?affiliateId=${encodeURIComponent(params.affiliateId)}` : "";
		return await fetcher(`${STRIPE_API_ROUTE}/promo-codes${qs}`, authAPIOptions, otherOptions, { method: "GET" });
	};
	/**
