...
const getDictionaryAPI = (authAPIOptions = {}, intlayerConfig) => {
	const PROJECT_API_ROUTE = `${intlayerConfig?.editor?.backendURL ?? editor.backendURL}/api/dictionary`;
	/**
	...
	* @param version - Dictionary version of content.
	*/
	const getDictionariesByKeys = async (dictionaryKeys, version, otherOptions = {}) => await fetcher(`${PROJECT_API_ROUTE}/by-keys`, authAPIOptions, otherOptions, {
		cache: "no-store",
		params: {
