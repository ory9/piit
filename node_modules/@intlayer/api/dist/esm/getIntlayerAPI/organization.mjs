...
const getOrganizationAPI = (authAPIOptions = {}, intlayerConfig) => {
	const ORGANIZATION_API_ROUTE = `${intlayerConfig?.editor?.backendURL ?? editor.backendURL}/api/organization`;
	/**
	...
	* @param organizationId - Organization ID.
	*/
	const deleteOrganizationByIdAdmin = async (organizationId, otherOptions = {}) => fetcher(`${ORGANIZATION_API_ROUTE}/${organizationId}/admin`, authAPIOptions, otherOptions, { method: "DELETE" });
	/**
