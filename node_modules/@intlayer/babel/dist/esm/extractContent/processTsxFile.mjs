...
const processTsxFile = (filePath, componentKey, packageName, configuration, save = true, unmergedDictionaries = {}, providedFileCode) => {
	...
	const { extractedContent, replacements, componentsNeedingHooks, componentKeyMap, componentPaths, hookMap, existingInfoByNode: existingInfoCache } = extractBabelContentForComponents(ast, fileCode, /* @__PURE__ */ new Set(), componentKey, configuration, filePath, unmergedDictionaries);
