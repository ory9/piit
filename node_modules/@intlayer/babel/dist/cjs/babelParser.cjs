...
*/
const buildBabelOptions = (extraPlugins) => ({
	sourceType: "module",
	strictMode: false,
...
const typescriptParser = { parse: (source) => (0, _babel_parser.parse)(source, buildBabelOptions(["typescript"])) };
/** Drop-in replacement for `recast/parsers/babel-ts` (TS *and* JSX). */
const babelTsParser = { parse: (source) => (0, _babel_parser.parse)(source, buildBabelOptions(["jsx", "typescript"])) };

//#endregion
exports.babelTsParser = babelTsParser;
exports.typescriptParser = typescriptParser;
//# sourceMappingURL=babelParser.cjs.map