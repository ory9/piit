...
*/
const formatOptimizedNestingEnvVar = (isOptimized, wrapKey = (key) => key, wrapValue = (value) => value) => isOptimized ? { [wrapKey("INTLAYER_OPTIMIZED_NESTING")]: wrapValue("true") } : {};
/**
...
const getConfigEnvVars = (config, wrapKey = (key) => key, wrapValue = (value) => value) => {
	...
	else if (routing.enableProxy === true) envVars[wrapKey("INTLAYER_ROUTING_ENABLE_PROXY")] = wrapValue("true");
...
exports.formatOptimizedNestingEnvVar = formatOptimizedNestingEnvVar;
