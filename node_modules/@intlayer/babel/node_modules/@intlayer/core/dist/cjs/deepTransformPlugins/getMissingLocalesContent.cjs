...
const checkMissingLocalesPlugin = (locales, onMissingLocale) => ({
	...
	transform: (node, props, deepTransformNode) => {
		const translations = node[_intlayer_types_nodeType.TRANSLATION];
		/**
...
*/
const getMissingLocalesContent = (node, locales = _intlayer_config_built.internationalization?.locales, nodeProps) => {
...
const getMissingLocalesContentFromDictionary = (dictionary, locales = _intlayer_config_built.internationalization?.locales) => getMissingLocalesContent(dictionary.content, locales, {
