...
const require_transpiler_html_validateHTML = require('../html/validateHTML.cjs');

//#region src/transpiler/markdown/validateMarkdown.ts
/**
...
const validateCodeBlocks = (content) => {
	const issues = [];
	const lines = content.split("\n");
	let inCodeBlock = false;
	let openFence = null;
...
const validateMarkdown = (content) => {
	...
	const htmlIssues = require_transpiler_html_validateHTML.validateHTML(stripCode(content)).issues;
