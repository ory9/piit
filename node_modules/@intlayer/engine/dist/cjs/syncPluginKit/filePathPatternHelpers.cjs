...
//#region src/syncPluginKit/filePathPatternHelpers.ts
/**
...
*/
const buildFilePathPatternContext = (key, locale) => ({
	key,
	locale
});

//#endregion
exports.buildFilePathPatternContext = buildFilePathPatternContext;
//# sourceMappingURL=filePathPatternHelpers.cjs.map