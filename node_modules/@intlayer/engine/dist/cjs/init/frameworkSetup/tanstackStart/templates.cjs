...
*/
const buildRootTemplateTs = (localeSegment) => `import {
  createRootRoute,
  getRouteApi,
  HeadContent,
  Scripts,
...
const buildRootTemplateJs = (localeSegment) => `import {
  createRootRoute,
  getRouteApi,
  HeadContent,
  Scripts,
...
exports.buildRootTemplateJs = buildRootTemplateJs;
exports.buildRootTemplateTs = buildRootTemplateTs;
