...
type ContentAdapter = {
   ...
   */
  read: (entry: ContentEntry, context: SyncPluginContext) => Promise<SyncContent | undefined>;
  /**
   ...
   */
  write: (target: ContentTarget, content: SyncContent, context: SyncPluginContext) => Promise<void>;
  /**
   ...
   */
  resolveUri?: (target: ContentTarget, context: SyncPluginContext) => Promise<string>;
  /**
...
type FormatCodec = {
   ...
   */
  serialize: (content: SyncContent, context: {
    locale: Locale;
  }) => string;
};
/**
 ...
 */
type SyncDirection = 'pull' | 'both';
/**
 * Options of `createSyncPlugin`.
 */
type CreateSyncPluginOptions = {
...
//#endregion
export { ContentAdapter, ContentEntry, ContentTarget, CreateSyncPluginOptions, FormatCodec, SyncContent, SyncDirection, SyncPluginContext };
