 ...
 */
type DotPath<T> = T extends object ? { [K in keyof T & (string | number)]: T[K] extends object // Either just K, or K + '.' + deeper path
...
type ValidDotPathsFor<K extends DictionaryKeys> = DotPath<DeepReplace<DeepTransformContent<DictionaryRegistryContent<K>>, {
  type: any;
  props: any;
  key: any;
}, string>>;
type NestedContentState<K extends DictionaryKeys> = {
  dictionaryKey: K;
  /**
...
type NestedContent<K extends DictionaryKeys = never> = TypedNodeModel<typeof NESTED, NestedContentState<K>>;
/**
