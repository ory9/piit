...
const resolveOutputPattern = async (output, locale, context, sourceFilePath, baseDir) => {
	...
	const rawPath = typeof pattern === "function" ? await pattern(context) : (0, _intlayer_config_utils.parseStringPattern)(pattern, context);
	return (0, _intlayer_engine_utils.resolveRelativePath)(rawPath, sourceFilePath, baseDir);
};
