...
const renderMarkdown = (content, { components, wrapper, forceBlock, forceInline, preserveFrontmatter, tagfilter } = {}) => {
	return require_markdown_processor.compileMarkdown(content, {
		components,
		forceBlock,
		forceInline,
		wrapper,
...
const MarkdownRenderer = ({ children = "", components, wrapper, forceBlock, forceInline, preserveFrontmatter, tagfilter, renderMarkdown }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: require_markdown_processor.compileMarkdown(children, {
		components,
		forceBlock,
		forceInline,
		wrapper,
