...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      {/* Back link */}
      <Link href="/blog" className="inline-flex items-center gap-1 text-sm text-red-600 hover:text-red-700 mb-6 transition-colors">
      ...
      <div
        className="prose prose-sm sm:prose max-w-none text-gray-700 leading-relaxed
          ...
          prose-blockquote:border-l-red-400 prose-blockquote:text-gray-600"
      ...
      <div className="mt-10 pt-6 border-t border-gray-100">
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-red-50 text-red-700 font-semibold text-sm hover:bg-red-100 transition-colors"
        >
          ← More articles
        </Link>
      </div>
